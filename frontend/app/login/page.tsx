        ...
        <div className="w-full md:w-3/5 flex justify-center items-start relative overflow-y-auto">
          ...
          <div className="w-full max-w-md z-10 px-4 py-8 md:py-12">
            <div className="bg-white rounded-2xl shadow-xl p-10">
              {view === 'login' && <LoginCard view={view} setView={setView} />}
              {view === 'signup-individual' && <LoginCard view={view} setView={setView} />}
              {view === 'signup-business' && <LoginCard view={view} setView={setView} />}
              {view === 'forgot-password' && <ForgotPasswordCard setView={setView} />}
            </div>
          </div>
        </div>
